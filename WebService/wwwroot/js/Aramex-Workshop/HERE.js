...
import { router, searchService } from './app.js';
...
const requestRouteInfo = options => {
    const params = {
        ...
        'mode': `fastest;${options.mode};traffic:${options.traffic}`,
...
const requestReverseGeocodeInfo = options => {
    const params = {
        'at': `${options.at}`,
...
export { requestRouteInfo, requestReverseGeocodeInfo }
