...
const requestGeocode = locationid => {
 ...
 const autocompleteGeocodeUrl = (query) => `https://autocomplete.geocoder.ls.hereapi.com/6.2/suggest.json?apiKey=${config.hereCredentials.apikey}&resultType=areas&query=${query}`
